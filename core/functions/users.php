...
function change_profile_image($user_id, $file_temp, $file_extn){
	$file_path = "images/profile/" .$user_id ."_profie_pic.".$file_extn;
...
function email($to, $subject, $body){
	mail($to, $subject, $body, 'From: useryou');
}
...
\nYou need to activate your account to start posting.

\nYou can activate by following the link.

\n http://www.webdevuk.co.uk/activate.php?email=".$register_data['email'] . "&email_code=" . $register_data['email_code'] . "
\n\nThe UserYou team.
	");
}
